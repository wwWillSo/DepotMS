...
public class StaffDAOHibernate4 implements StaffDAO{
	...
	public Staff get(Class<Staff> entityClazz, Serializable id) {
		return (Staff)getSessionFactory().getCurrentSession().get(entityClazz, id) ;
	}
	...
	public List<Staff> find(String hql) {
		return (List<Staff>)getSessionFactory().getCurrentSession().createQuery(hql).list() ;
	}
