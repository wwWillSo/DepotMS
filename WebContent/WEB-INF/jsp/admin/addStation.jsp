...
<body>
	...
	<div id="stationInfo">
		...
		人数：<input type="text" name="population" id="population" placeHolder="人数" readonly="readonly"/><br>
		序号：<input type="text" name="step" id="step" placeHolder="站点序号" readonly="readonly"/><br>
		
		<button type="button" id="delete" class="btn default-btn">删除站点</button><br>
	</div>
	...
	<div id="option">
		...
		<form action="" method="post">
			<input type="text" name="newStationName" id="newStationName" placeHolder="新站点名称" readonly="readonly"/>
			<input type="text" name="newStationLongitude" id="newStationLongitude" placeHolder="新站点经度" />
			<input type="text" name="newStationLatitude" id="newStationLatitude" placeHolder="新站点纬度"/>
			<input type="text" name="newAddress" id="newAddress" placeHolder="新站点详细地址" readonly="readonly"size="40"/>
			<button type="button" id="confirm" class="btn default-btn">设置站点</button><br>
			<button type="button" class="btn default-btn" onClick="add_control()">添加网格</button>
			<button type="button" class="btn default-btn" onClick="delete_control()">删除网格</button><br>
